...
import (
	...
	"github.com/prathoss/integration_testing/service_profile/repository"
)
...
func New(cfg config.Config) (*Server, error) {
	...
	pictureClient := picture.NewClient(cfg.PictureAddress)

	return &Server{
		config:            cfg,
		closers:           []closer{pgConn},
		profileRepository: repository.NewProfile(pgConn),
